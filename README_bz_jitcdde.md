...
Ce script implémente le modèle Oregonator réversible à quatre variables (Doumbouya et al. 1993) pour la réaction de Belousov-Zhabotinsky (BZ) avec feedback retardé de type Roesky (1993).
